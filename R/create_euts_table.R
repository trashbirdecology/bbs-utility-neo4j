...
euts_to_paraphrased <- euts %>% filter(ChildNodeId %in% paraphrased_responses$ChildNodeId)
euts_to_jlb_interpreted <-euts %>% filter(!ChildNodeId %in% paraphrased_responses$ChildNodeId)
